...
public class PaymentModule extends ReactContextBaseJavaModule implements ActivityEventListener,PermissionListener {
...
@ReactMethod
public void show_aeps(String saltkey,String secretkey,String bcid,String userid,String bcemailid,String phone1,String clientredid ,Promise promise) {
  ...
  try {
   ...
   intent.putExtra("Phone1",phone1);
    intent.putExtra("cpid",clientredid);//(If any) 
   activity.startActivityForResult(intent, 4);
   mPromises.put(4, promise);
